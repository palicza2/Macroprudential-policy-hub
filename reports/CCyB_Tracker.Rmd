...
write_xlsx(agg_trend, paste0(output_dir, "data_diffusion.xlsx"))
write_xlsx(latest_df %>% filter(date >= (Sys.Date() - years(1))), paste0(output_dir, "data_latest_decisions.xlsx"))
write_xlsx(latest_df, paste0(output_dir, "data_snapshot.xlsx"))
write_xlsx(neutral_df, paste0(output_dir, "data_pn_ccyb.xlsx"))
write_xlsx(df, paste0(output_dir, "data_historical.xlsx"))
write_xlsx(latest_df %>% filter(!is.na(credit_gap)), paste0(output_dir, "data_risk_analysis.xlsx"))
```
